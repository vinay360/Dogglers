...
public final class LayoutViewHolderBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutViewHolderBinding(@NonNull MaterialCardView rootView, @NonNull TextView dogAge,
  ...
  @NonNull
  public static LayoutViewHolderBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutViewHolderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_view_holder, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutViewHolderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutViewHolderBinding((MaterialCardView) rootView, dogAge, dogHobbies, dogImage,
          dogName);
    }
