...
public final class FragmentSecondBinding implements ViewBinding {
  ...
  private FragmentSecondBinding(@NonNull ConstraintLayout rootView, @NonNull TextView dogAge,
  ...
  public static FragmentSecondBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSecondBinding((ConstraintLayout) rootView, dogAge, dogHobbies, dogImage,
